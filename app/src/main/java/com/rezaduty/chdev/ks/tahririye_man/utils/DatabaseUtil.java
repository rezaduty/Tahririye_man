...
public class DatabaseUtil {
    ...
    public void saveSourceInDB(SourceItem sourceItem) {
        ...
        DatabaseOperations databaseOperations = new DatabaseOperations(mContext, "tahririye_man_db.sqlite");
    ...
    public void deleteAllFeeds() throws Exception {
        new DatabaseOperations(mContext, "tahririye_man_db.sqlite").deleteAllFromDB("feed_table");
    }
