package com.rezaduty.chdev.ks.nta.utils;

import android.content.Context;
import android.database.Cursor;

import com.rezaduty.chdev.ks.mindb.DatabaseOperations;
...
public class DatabaseUtil {
    ...
    public void saveSourceInDB(SourceItem sourceItem) {
        ...
        DatabaseOperations databaseOperations = new DatabaseOperations(mContext, "nta_db.sqlite");
    ...
    public void deleteAllFeeds() throws Exception {
        new DatabaseOperations(mContext, "nta_db.sqlite").deleteAllFromDB("feed_table");
    }
