...
import com.rezaduty.chdev.ks.tahririye_man.models.LibraryItem;
import com.rezaduty.chdev.ks.tahririye_man.models.SettingsPreferences;
import com.rezaduty.chdev.ks.tahririye_man.ui.adapters.LibrariesRecyclerViewAdapter;
...
public class AboutActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_rate) {
            ...
            intent.setData(Uri.parse("market://details?id=com.rezaduty.chdev.ks.munch"));
