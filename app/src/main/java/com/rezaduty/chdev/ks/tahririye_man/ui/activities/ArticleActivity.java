...
import com.rezaduty.chdev.ks.tahririye_man.article.ArticlePresenter;
import com.rezaduty.chdev.ks.tahririye_man.article.IArticleView;
...
public class ArticleActivity extends AppCompatActivity implements IArticleView, IFeedsView {
    ...
    public void onArticleFailedToLoad(String message) {
        Toast.makeText(ArticleActivity.this, "خطا در بارگذاری:\n" + message, Toast.LENGTH_SHORT).show();
    }
    ...
    public void onArticleSaved(String message) {
        mSaved = true;
        fabArchive.setImageResource(R.drawable.ic_archive_done_24dp);
        Toast.makeText(ArticleActivity.this, "ذخیره شد: " + message, Toast.LENGTH_SHORT).show();
    }
