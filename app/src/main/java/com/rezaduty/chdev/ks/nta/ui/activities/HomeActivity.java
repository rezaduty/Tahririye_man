...
import com.rezaduty.chdev.ks.nta.models.Categories;
import com.rezaduty.chdev.ks.nta.models.CategoryItem;
...
import com.rezaduty.chdev.ks.nta.ui.adapters.CategoryListAdapter;
import com.rezaduty.chdev.ks.nta.ui.fragments.ArchiveFragment;
import com.rezaduty.chdev.ks.nta.ui.fragments.FeedsFragment;
import com.rezaduty.chdev.ks.nta.ui.fragments.ManageSourcesFragment;
import com.rezaduty.chdev.ks.nta.utils.AnimationUtil;
import com.rezaduty.chdev.ks.nta.utils.DateUtil;
...
public class HomeActivity extends AppCompatActivity implements ISourceView, FloatingActionMenu.OnMenuToggleListener, AdapterView.OnItemSelectedListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    public void dataSourceSaveFailed(String message) {
        if (message.equals("name_url_category_empty")) {
            ...
            message = "نام منبع نمیتواند خالی باشد";
            ...
            eTxtSourceUrl.setError("آدرس منبع نامتعبر");
        }
        Toast.makeText(HomeActivity.this, message, Toast.LENGTH_SHORT).show();
    }
